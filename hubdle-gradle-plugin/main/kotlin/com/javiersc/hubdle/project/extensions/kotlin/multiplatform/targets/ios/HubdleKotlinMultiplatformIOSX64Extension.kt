...
@HubdleDslMarker
public open class HubdleKotlinMultiplatformIOSX64Extension @Inject constructor(project: Project) :
    ...
    public override val targetName: String = "iosX64"

    override val requiredExtensions: Set<HubdleEnableableExtension>
        get() = setOf(hubdleKotlinMultiplatform.apple.ios)

    override fun Project.defaultConfiguration() {
        configurableTargetPerOs(operativeSystem = OperatingSystem.current().isMacOsX) { iosX64() }
    }
}
