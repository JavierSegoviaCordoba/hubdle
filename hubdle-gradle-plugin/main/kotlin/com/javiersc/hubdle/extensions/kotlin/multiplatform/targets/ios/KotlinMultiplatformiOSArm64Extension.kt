...
@HubdleDslMarker
public open class KotlinMultiplatformiOSArm64Extension :
    EnableableOptions, KotlinMultiplatformTargetOptions {

    override var Project.isEnabled: Boolean
        get() = hubdleState.kotlin.multiplatform.iosArm64.isEnabled
        set(value) = hubdleState.kotlin.multiplatform.iosArm64.run { isEnabled = value }
