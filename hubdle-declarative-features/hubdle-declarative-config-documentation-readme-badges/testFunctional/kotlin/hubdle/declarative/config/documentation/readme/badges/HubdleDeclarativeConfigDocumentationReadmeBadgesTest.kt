...
class HubdleDeclarativeConfigDocumentationReadmeBadgesTest : GradleTestKitTest() {

    @Test
    fun `GIVEN a project WHEN hubdle config documentation readme badges is enabled THEN badges feature is applied`() {
