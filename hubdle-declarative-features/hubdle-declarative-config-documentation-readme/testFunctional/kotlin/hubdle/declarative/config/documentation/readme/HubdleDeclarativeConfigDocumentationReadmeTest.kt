...
class HubdleDeclarativeConfigDocumentationReadmeTest : GradleTestKitTest() {

    @Test
    fun `GIVEN a project WHEN hubdle config documentation readme is enabled THEN readme feature is applied`() {
