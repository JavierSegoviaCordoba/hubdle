...
class HubdleDeclarativeConfigAnalysisSonarTest : GradleTestKitTest() {

    @Test
    fun `GIVEN a project WHEN hubdle config analysis sonar is enabled THEN sonar feature is applied`() {
