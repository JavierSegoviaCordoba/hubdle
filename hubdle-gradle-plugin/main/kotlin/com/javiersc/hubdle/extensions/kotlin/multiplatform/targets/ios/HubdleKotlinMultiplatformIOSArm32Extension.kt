...
@HubdleDslMarker
public open class HubdleKotlinMultiplatformIOSArm32Extension
@Inject
constructor(
    project: Project,
    ...
    public override val targetName: String = "iosArm32"

    override val requiredExtensions: Set<HubdleEnableableExtension>
        get() = setOf(hubdleKotlinMultiplatform.apple.ios)

    override fun Project.defaultConfiguration() {
        configurableTargetPerOs(operativeSystem = OperatingSystem.current().isMacOsX) { iosArm32() }
    }
}
