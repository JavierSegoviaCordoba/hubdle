...
import hubdle.declarative.config.documentation.readme.HubdleConfigDocumentationReadmeDefinition
...
internal abstract class HubdleConfigDocumentationReadmeBadgesApplyAction :
    ProjectFeatureApplyAction<
        HubdleConfigDocumentationReadmeBadgesDefinition,
        HubdleConfigDocumentationReadmeBadgesBuildModel,
    ...
    override fun apply(
        ...
        definition: HubdleConfigDocumentationReadmeBadgesDefinition,
        buildModel: HubdleConfigDocumentationReadmeBadgesBuildModel,
        parentDefinition: HubdleConfigDocumentationReadmeDefinition,
    ) = definition.run {
