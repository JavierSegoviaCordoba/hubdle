...
* 1,314 number of properties

* 548 number of functions
...
* 13,081 lines of code (loc)

* 10,770 source lines of code (sloc)

* 7,086 logical lines of code (lloc)

* 101 comment lines of code (cloc)

* 928 cyclomatic complexity (mcc)

* 476 cognitive complexity
...
generated with [detekt version 1.22.0](https://detekt.dev/) on 2023-03-10 01:13:36 UTC
