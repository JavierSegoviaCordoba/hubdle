...
@CacheableTask
abstract class PreBuildDocsTask
@Inject
constructor(
    ...
    val dotDocsDirectory: File
        get() = File("${layout.projectDirectory.asFile}/.docs/").apply(File::mkdirs)

    @get:Nested abstract val projectsInfo: ListProperty<ProjectInfo>

    @get:Input abstract val allTests: Property<Boolean>

    @get:Input abstract val codeAnalysis: Property<Boolean>

    @get:Input abstract val codeCoverage: Property<Boolean>

    @get:Input abstract val codeQuality: Property<Boolean>
    ...
    @get:OutputDirectory
    val buildDotDocsDirectory: File
    ...
    companion object {
        const val name = "preBuildDocs"
        const val taskGroup = "build"

        internal fun register(
            project: Project,
            configure: PreBuildDocsTask.() -> Unit
        ): TaskProvider<PreBuildDocsTask> =
            project.tasks.register<PreBuildDocsTask>(name) {
                group = taskGroup
                configure(this)
            }
    }
