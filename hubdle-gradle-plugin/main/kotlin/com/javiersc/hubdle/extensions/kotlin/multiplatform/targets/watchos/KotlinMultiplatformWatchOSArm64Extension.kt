...
@HubdleDslMarker
public open class KotlinMultiplatformWatchOSArm64Extension :
    EnableableOptions, KotlinMultiplatformTargetOptions {

    override var Project.isEnabled: Boolean
        get() = hubdleState.kotlin.multiplatform.watchosArm64.isEnabled
        set(value) = hubdleState.kotlin.multiplatform.watchosArm64.run { isEnabled = value }
