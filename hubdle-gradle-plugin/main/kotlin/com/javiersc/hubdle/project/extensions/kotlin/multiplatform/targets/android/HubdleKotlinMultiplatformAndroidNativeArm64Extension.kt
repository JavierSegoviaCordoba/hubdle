...
@HubdleDslMarker
public open class HubdleKotlinMultiplatformAndroidNativeArm64Extension
@Inject
constructor(
    project: Project,
    ...
    public override val targetName: String = "androidNativeArm64"

    override val requiredExtensions: Set<HubdleEnableableExtension>
        get() = setOf(hubdleKotlinMultiplatform.androidNative)

    override fun Project.defaultConfiguration() {
        lazyConfigurable { configure<KotlinMultiplatformExtension> { androidNativeArm64() } }
    }
}
