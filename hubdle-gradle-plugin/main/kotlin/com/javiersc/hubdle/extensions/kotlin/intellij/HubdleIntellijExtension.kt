...
@HubdleDslMarker
public open class HubdleIntellijExtension
@Inject
constructor(
    objects: ObjectFactory,
) :
    EnableableOptions,
    FeaturesOptions<HubdleIntellijExtension.FeaturesExtension>,
    KotlinJvmOptions,
    SourceDirectoriesOptions<KotlinSourceSet>,
    RawConfigOptions<HubdleIntellijExtension.RawConfigExtension>,
