...
internal fun Project.configureDefaultJavaSourceSets() {
    configure<JavaPluginExtension> { sourceSets.all { set -> set.configJavaDefaultSourceSets() } }
}

internal fun Project.configureDefaultKotlinSourceSets(targets: Set<String> = emptySet()) {
