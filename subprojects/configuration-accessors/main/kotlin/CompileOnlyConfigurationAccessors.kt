...
public fun DependencyHandler.`compileOnly`(
    ...
    addConfiguredDependencyTo(this, "compileOnly", dependencyNotation, dependencyConfiguration)
 ...
 */
public fun DependencyConstraintHandler.`compileOnly`(
    constraintNotation: Any
): DependencyConstraint? = add("compileOnly", constraintNotation)
