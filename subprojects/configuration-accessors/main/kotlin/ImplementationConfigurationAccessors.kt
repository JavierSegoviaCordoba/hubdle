...
public fun DependencyHandler.`implementation`(
    ...
    addConfiguredDependencyTo(this, "implementation", dependencyNotation, dependencyConfiguration)
 ...
 */
public fun DependencyConstraintHandler.`implementation`(
    constraintNotation: Any
): DependencyConstraint? = add("implementation", constraintNotation)
...
): DependencyConstraint? = add("implementation", constraintNotation, block)
...
): PublishArtifact = add("implementation", artifactNotation, configureAction)
