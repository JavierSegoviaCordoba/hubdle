...
internal abstract class HubdleAnalysisSonarApplyAction :
    ProjectFeatureApplyAction<
        HubdleAnalysisSonarDefinition,
        HubdleAnalysisSonarBuildModel,
    ...
    override fun apply(
        ...
        definition: HubdleAnalysisSonarDefinition,
        buildModel: HubdleAnalysisSonarBuildModel,
        parentDefinition: HubdleAnalysisDefinition,
    ) = definition.run {
    ...
    private fun HubdleAnalysisSonarDefinition.configSonar() {
