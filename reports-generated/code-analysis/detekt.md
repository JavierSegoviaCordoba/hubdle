...
* 11,750 lines of code (loc)

* 9,734 source lines of code (sloc)

* 6,615 logical lines of code (lloc)

* 52 comment lines of code (cloc)

* 1,231 cyclomatic complexity (mcc)
...
generated with [detekt version 1.21.0](https://detekt.dev/) on 2022-09-29 19:56:51 UTC
