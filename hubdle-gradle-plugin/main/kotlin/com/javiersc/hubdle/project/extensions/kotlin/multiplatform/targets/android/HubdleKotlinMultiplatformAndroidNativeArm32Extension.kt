...
@HubdleDslMarker
public open class HubdleKotlinMultiplatformAndroidNativeArm32Extension
@Inject
constructor(
    project: Project,
    ...
    public override val targetName: String = "androidNativeArm32"

    override val requiredExtensions: Set<HubdleEnableableExtension>
        get() = setOf(hubdleKotlinMultiplatform.androidNative)

    override fun Project.defaultConfiguration() {
        lazyConfigurable { configure<KotlinMultiplatformExtension> { androidNativeArm32() } }
    }
}
