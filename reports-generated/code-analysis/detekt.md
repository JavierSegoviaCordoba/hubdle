...
* 1,300 number of properties

* 544 number of functions
...
* 12,801 lines of code (loc)

* 10,515 source lines of code (sloc)

* 6,930 logical lines of code (lloc)

* 104 comment lines of code (cloc)

* 921 cyclomatic complexity (mcc)
...
generated with [detekt version 1.22.0](https://detekt.dev/) on 2023-02-13 22:52:17 UTC
