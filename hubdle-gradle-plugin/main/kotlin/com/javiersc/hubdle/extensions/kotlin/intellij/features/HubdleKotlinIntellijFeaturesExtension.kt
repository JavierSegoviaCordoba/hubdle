package com.javiersc.hubdle.extensions.kotlin.intellij.features
...
@HubdleDslMarker
public open class HubdleKotlinIntellijFeaturesExtension
@Inject
constructor(
    project: Project,
) : HubdleEnableableExtension(project), HubdleKotlinIntellijDelegateFeaturesExtension {
    ...
    override val requiredExtensions: Set<HubdleEnableableExtension>
        get() = setOf(hubdleIntellij)
}

public interface HubdleKotlinIntellijDelegateFeaturesExtension :
...
internal val HubdleEnableableExtension.hubdleIntellijFeatures: HubdleKotlinIntellijExtension
