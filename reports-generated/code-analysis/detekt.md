...
* 13,100 lines of code (loc)

* 10,781 source lines of code (sloc)

* 7,092 logical lines of code (lloc)

* 103 comment lines of code (cloc)

* 934 cyclomatic complexity (mcc)

* 481 cognitive complexity
...
* hubdle-project-gradle-plugin/main/kotlin/com/javiersc/hubdle/project/extensions/shared/features/gradle/HubdleGradlePluginFeatureExtension.kt:96:26
```
The function defaultConfiguration is too long (60). The maximum length is 60.
```
```kotlin
93          )
94      }
95  
96      override fun Project.defaultConfiguration() {
!!                           ^ error
97          applicablePlugin(
98              priority = Priority.P3,
99              scope = Scope.CurrentProject,
...
generated with [detekt version 1.22.0](https://detekt.dev/) on 2023-03-05 01:15:38 UTC
