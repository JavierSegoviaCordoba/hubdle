...
public fun DependencyHandler.`testRuntimeOnly`(
    ...
    addConfiguredDependencyTo(this, "testRuntimeOnly", dependencyNotation, dependencyConfiguration)
 ...
 */
public fun DependencyConstraintHandler.`testRuntimeOnly`(
    constraintNotation: Any
): DependencyConstraint? = add("testRuntimeOnly", constraintNotation)
...
): DependencyConstraint? = add("testRuntimeOnly", constraintNotation, block)
...
): PublishArtifact = add("testRuntimeOnly", artifactNotation, configureAction)
