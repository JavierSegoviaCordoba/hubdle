...
public fun DependencyHandler.`runtimeOnly`(
    ...
    addConfiguredDependencyTo(this, "runtimeOnly", dependencyNotation, dependencyConfiguration)
 ...
 */
public fun DependencyConstraintHandler.`runtimeOnly`(
    constraintNotation: Any
): DependencyConstraint? = add("runtimeOnly", constraintNotation)
...
): DependencyConstraint? = add("runtimeOnly", constraintNotation, block)
...
): PublishArtifact = add("runtimeOnly", artifactNotation, configureAction)
