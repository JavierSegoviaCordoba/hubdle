...
@HubdleDslMarker
public open class KotlinMultiplatformLinuxX64Extension @Inject constructor(project: Project) :
    ...
    override fun Project.defaultConfiguration() {
        configurableTargetPerOs(operativeSystem = OperatingSystem.current().isLinux) { linuxX64() }
    }
}
