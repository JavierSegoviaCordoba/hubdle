...
* 1,267 number of properties

* 533 number of functions

* 222 number of classes

* 73 number of packages

* 204 number of kt files

## Complexity Report

* 12,478 lines of code (loc)

* 10,241 source lines of code (sloc)

* 6,777 logical lines of code (lloc)

* 97 comment lines of code (cloc)

* 901 cyclomatic complexity (mcc)
...
generated with [detekt version 1.22.0](https://detekt.dev/) on 2023-01-25 03:20:11 UTC
